    ...
    <>
      ...
      {selected ? (
        <div className="fixed inset-0 z-40 flex justify-end bg-black/40">
          <section className="h-full w-full max-w-xl overflow-y-auto bg-paper p-5 shadow-soft">
            ...
            <form onSubmit={renamePlaylist} className="mt-5 flex gap-2 rounded-lg border border-line bg-white p-3">
              ...
              <button title="Rename playlist" className="inline-flex items-center gap-2 rounded-md bg-ink px-3 py-2 text-sm font-medium text-white"><Pencil size={15} /> Save</button>
            </form>
